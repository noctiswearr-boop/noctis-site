    ...
    <main className="min-h-screen bg-gradient-to-b from-black via-[#061326] to-black px-8 py-10 text-white">
      ...
      <section className="mx-auto grid max-w-6xl gap-12 py-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h1 className="font-serif text-5xl tracking-[0.2em]">{product.name}</h1>

          <p className="mt-6 text-3xl">{product.price} TL</p>

          <p className="mt-8 max-w-lg text-gray-300">{product.description}</p>

          <div className="mt-10">
            <p className="mb-3 text-sm uppercase tracking-[0.3em]">Beden Seç</p>
              ...
              {["S", "M", "L", "XL"].map((s) => (
                <button
                  ...
                  className={`h-12 w-14 rounded-full border ${
                    size === s ? "border-blue-300 text-blue-200" : "border-white/20"
                  }`}
                >
                  {s}
                </button>
